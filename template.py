...
list_of_files = [
    ...
    f"src/{project_name}/pipeline/1_data_ingestion.py",
    f"src/{project_name}/pipeline/2_prepare_base_model.py",
    f"src/{project_name}/pipeline/3_model_trainer.py",
    f"src/{project_name}/pipeline/4_model_evaluation.py",
